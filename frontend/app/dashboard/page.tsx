    ...
    return (
        <div>
            <div className='flex gap-6 mb-6'>
                <div className="bg-white lg:p-6 p-3 flex items-center justify-between rounded-lg flex-1 shadow-sm">
                    <div>
            ...
            <div className='flex items-center gap-6'>
                <div className='bg-white flex-1 lg:p-6 p-3 rounded-lg mb-6 shadow-sm'>
                    <h4 className='font-semibold text-xl text-t2m-text-primary'>Income vs Expenses</h4>
                </div>
                <div className='bg-white flex-1 lg:p-6 p-3 rounded-lg mb-6 shadow-sm'>
                    <h4 className='font-semibold text-xl text-t2m-text-primary'>Expense Category</h4>
                </div>
            </div>
            <div className='bg-white rounded-lg lg:p-6 p-3 shadow-sm'>
