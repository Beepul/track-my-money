    ...
    return (
        <div>
            <div className='flex gap-6 mb-6'>
                <div className="bg-white lg:p-6 p-3 flex items-center justify-between rounded-lg flex-1">
                    <div>
            ...
            <div className='flex items-center gap-6'>
                <div className='bg-white flex-1 lg:p-6 p-3 rounded-lg mb-6'>
            ...
            <div className='bg-white rounded-lg lg:p-6 p-3'>
